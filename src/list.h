...
__attribute_used__ static const klangc_str_t *klangc_nil_str(void) {
...
__attribute_used__ static const klangc_symbol_t *klangc_nil_symbol(void) {
...
__attribute_used__ static klangc_pat_alge_t *klangc_nil_pat_alge(void) {
...
__attribute_used__ static klangc_expr_alge_t *klangc_nil_expr_alge(void) {
...
__attribute_used__ static const klangc_str_t *klangc_cons_str(void) {
...
__attribute_used__ static const klangc_symbol_t *klangc_cons_symbol(void) {
