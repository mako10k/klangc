...
typedef struct klangc_expr_lambda_put_arg_foreach_data {
  klangc_expr_closure_t *closure;
  klangc_expr_closure_bind_t *bind;
} klangc_expr_lambda_put_arg_foreach_data_t;

int klangc_expr_lambda_put_arg_foreach(klangc_ref_t *ref, void *data) {
  klangc_expr_lambda_put_arg_foreach_data_t *fdata = data;
...
int klangc_expr_lambda_check_unbound(klangc_output_t *output,
  ...
  return klangc_expr_check_unbound(output, klangc_expr_lambda_get_upper(lambda),
                                   body);
}