...
int klangc_closure_put_bind(klangc_closure_t *closure,
                            klangc_ref_t *ref, klangc_bind_t *bind);

int klangc_closure_get_bind(klangc_closure_t *closure,
                            klangc_ref_t *ref, klangc_bind_t **pbind,
                            klangc_closure_t **pclosure);
